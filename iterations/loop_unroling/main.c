 ...
 * Plus, Loop unrolling optimizations.
 * 
 * TODO: Is this needed? functions are already overloading the registers, loop unrolling may just decrease efficiency by going to the cache so often.
 */
